...
import 'package:northstars_final/presenters/se_compare_presenter.dart';

class SECompareView extends StatefulWidget {
  final SEComparePresenter seComparePresenter;

  const SECompareView(this.seComparePresenter, {super.key});

  @override
  _seCompareViewState createState() => _seCompareViewState();
}
class _seCompareViewState extends State<SECompareView> {
